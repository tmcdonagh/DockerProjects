...
sudo docker network disconnect wordpressBridge web-wordpress
...
sudo docker network connect --ip=172.18.0.2 wordpressBridge db-wordpress
sudo docker network connect --ip=172.18.0.3 wordpressBridge web-wordpress
